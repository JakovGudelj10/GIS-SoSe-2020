...
(function (Aufgabe05) {
    ...
    const bigmac = { _name: "BigMac", _beschreibung: "Der absolute Have to eat bei mittelgroßen Hunger!", _preis: "4,29€  ", _bild: "", _bildAlt: "BigMac", _verfuegbar: true };
    const bigtasty = { _name: "Big n'Tasty Bacon", _beschreibung: "Ein Burger mit Speck!", _preis: "5,19€  ", _bild: "", _bildAlt: "BigTastyBacon", _verfuegbar: true };
    ...
    const mcchicken = { _name: "McChicken", _beschreibung: "Zur Abwechslung stwas Hähnchen!", _preis: "2,99€  ", _bild: "", _bildAlt: "McChicken", _verfuegbar: true };
