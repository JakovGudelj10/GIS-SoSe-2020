namespace Aufgabe05 {
    ...
    const mcSundae: Artikel = {_name: "McSundae", _beschreibung: "Nach Wahl: Schoko, Erdbeer oder Karamell!", _preis: "1€  ", _bild: "newmcsun.png", _bildAlt: "McSundae", _verfuegbar: true};
